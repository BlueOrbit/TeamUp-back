...
//        dataSource.setUrl("jdbc:mysql://localhost:3306/teamup?serverTimezone=UTC");
...
//        globalConfig.setAuthor("BlueOrbit");    //设置作者
...
//        packageInfo.setParent("com.blueorbit.teamup");   //设置生成的包名，与代码所在位置不冲突，二者叠加组成完整路径
...
//        strategyConfig.setInclude("team");
